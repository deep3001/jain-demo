...
export const TodaysFailedOrdersBox = (props) => {
  const { amount} = props;
  console.log(amount);
      ...
      >
        <Box sx={{ flexGrow: 2 }}>
          <Typography color="text.secondary" variant="body2">
            Todays Failed Orders
          </Typography> 
          <div style={{ display: "flex", alignItems: "center" }}>
          <Typography color="text.primary" variant="h4">
            {amount.todaysFailedOrder}
          </Typography>
          <div
          style={{
            marginLeft: "8px",
